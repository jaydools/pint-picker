const createPrompt = (answers) => {
    return `
        ...
        Specific flavour notes they hate and never want. Be sure to take this as one of the most important factors in user preference: ${answers[5]}
